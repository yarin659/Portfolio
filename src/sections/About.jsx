  ...
  return (
    <section id="about" className="mx-auto max-w-6xl px-4 py-16">
      ...
      <div className="mt-6 flex gap-3">
        <a href="#contact" className="px-4 py-2 rounded-lg bg-indigo-600 text-white hover:opacity-90">{a.ctaPrimary}</a>
        <a href="#projects" className="px-4 py-2 rounded-lg border border-neutral-300 dark:border-neutral-700">{a.ctaSecondary}</a>
